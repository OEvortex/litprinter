...
from litprinter.coloring import CYBERPUNK, create_custom_style
...
def demonstrate_traceback():
    """Demonstrate traceback enhancement."""
    print("\n=== Traceback Enhancement Example ===")
    print("(This will raise an exception with a pretty traceback)")
    
    # Install the traceback handler
    install_traceback(
        theme="CYBERPUNK",
        show_locals=True,
        extra_lines=2
    ...
    try:
        ...
        print("(The above exception was displayed with enhanced traceback)")
